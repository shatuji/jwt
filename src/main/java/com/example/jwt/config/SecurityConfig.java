...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private MyFilterSecurityIntercepor myFilterSecurityIntercepor;
    @Bean
    ...
    protected void configure(HttpSecurity http) throws Exception {
     http
             ...
             .accessDeniedHandler(myAccessDeniedHandlers());
    //add our custom JWT security filter
        http.addFilterBefore(jwtAuthenticationFilter() , UsernamePasswordAuthenticationFilter.class);
        http.addFilterBefore(myFilterSecurityIntercepor , FilterSecurityInterceptor.class);
    }

    @Bean
    public AccessDeniedHandler myAccessDeniedHandlers(){
